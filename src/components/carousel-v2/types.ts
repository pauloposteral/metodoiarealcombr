...
export const TEMPLATE_PRESETS: TemplatePreset[] = [
  ...
  // === SAZONAL ===
  {
    ...
    themeId: 'contrast-bw',
    structure: ['cover', 'content', 'content', 'content', 'cta'],
    features: ['Promoção', 'Urgência', 'Oferta'],
  },
  {
    id: 'natal-fim-ano',
    name: 'Natal / Fim de Ano',
    description: 'Retrospectiva e metas para o novo ano',
    category: 'Sazonal',
    themeId: 'luxury-gold',
    structure: ['cover', 'content', 'content', 'content', 'content', 'summary', 'cta'],
    features: ['Retrospectiva', 'Metas', 'Inspiração'],
  },
  {
    id: 'lancamento-produto',
    name: 'Lançamento de Produto',
    description: 'Anuncie seu novo produto ou serviço',
    category: 'Sazonal',
    themeId: 'tech-purple',
    structure: ['cover', 'intro', 'content', 'content', 'content', 'cta'],
    features: ['Novidade', 'Expectativa', 'Conversão'],
  },
  {
    id: 'dia-das-maes',
    name: 'Dia das Mães',
    description: 'Conteúdo especial para datas comemorativas',
    category: 'Sazonal',
    themeId: 'cozy-blush',
    structure: ['cover', 'content', 'content', 'content', 'cta'],
    features: ['Emocional', 'Comemorativo', 'Conexão'],
  },
  ...
  // === PROFISSÃO ===
  {
    id: 'coach-mentoria',
    name: 'Coach / Mentor',
    description: 'Templates para coaches e mentores',
    category: 'Profissão',
    themeId: 'luxury-gold',
    structure: ['cover', 'intro', 'content', 'content', 'content', 'content', 'summary', 'cta'],
    features: ['Mentoria', 'Framework', 'Transformação'],
  },
  {
    id: 'nutricionista',
    name: 'Nutricionista / Saúde',
    description: 'Dicas de saúde e nutrição',
    category: 'Profissão',
    themeId: 'nature-forest',
    structure: ['cover', 'content', 'content', 'content', 'content', 'content', 'cta'],
    features: ['Saúde', 'Dicas', 'Bem-estar'],
  },
  {
    id: 'advogado',
    name: 'Advogado / Jurídico',
    description: 'Conteúdo jurídico acessível',
    category: 'Profissão',
    themeId: 'corporate-navy',
    structure: ['cover', 'intro', 'content', 'content', 'content', 'summary', 'cta'],
    features: ['Direito', 'Dicas', 'Informativo'],
  },
  {
    id: 'ecommerce',
    name: 'E-commerce / Loja',
    description: 'Vitrine de produtos e promoções',
    category: 'Profissão',
    themeId: 'minimal-cream',
    structure: ['cover', 'content', 'content', 'content', 'content', 'cta'],
    features: ['Produtos', 'Vitrine', 'Vendas'],
  },
  {
    id: 'imobiliaria',
    name: 'Imobiliária / Corretor',
    description: 'Apresentação de imóveis e dicas',
    category: 'Profissão',
    themeId: 'luxury-champagne',
    structure: ['cover', 'content', 'content', 'content', 'content', 'cta'],
    features: ['Imóveis', 'Luxo', 'Investimento'],
  },
  {
    id: 'fitness-personal',
    name: 'Personal / Fitness',
    description: 'Treinos e dicas fitness',
    category: 'Profissão',
    themeId: 'contrast-neon',
    structure: ['cover', 'content', 'content', 'content', 'content', 'content', 'cta'],
    features: ['Treino', 'Motivação', 'Fitness'],
  },
];
